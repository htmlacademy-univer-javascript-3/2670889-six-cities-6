...
type OfferPageProps = {
  ...
  onReviewSubmit?: (offerId: string, rating: number, text: string) => void;
};
...
export const OfferPage: React.FC<OfferPageProps> = ({
  ...
  const handleFavoriteClick = () => {
    onFavoriteToggle?.(currentOffer.id, !isFavorite);
  ...
  const handleReviewSubmit = (event: React.FormEvent) => {
    ...
    if (onReviewSubmit) {
      onReviewSubmit(currentOffer.id, reviewRating, reviewText);
